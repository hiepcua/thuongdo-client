    ...
    >
      ...
      >
        ...
        <el-table-column
          ...
          property="created_at"
        ></el-table-column>
        <el-table-column label="Mã vận đơn" width="150" property="bill_code">
          <template slot-scope="scope">
            <p v-for="i in scope.row.bill_code" :key="i">{{ i }}</p>
          </template>
        </el-table-column>
        ...
        <el-table-column label="Phí vận chuyển" property="delivery_cost">
          <template slot-scope="scope">
            <!-- <span v-if="scope.row.status.name != 'Chờ xử lý'">{{
              scope.row.delivery_cost | vnd
            }}</span> -->
            <span v-if="scope.row.delivery_cost == 0" class="bg-red">
              Chờ báo giá
            </span>
        ...
        <el-table-column label="Tổng phí thu" property="amount">
          <template slot-scope="scope">
            <!-- <span>{{ scope.row.amount | vnd }}</span> -->
            <span class="bg-red" v-if="isNaN(scope.row.amount)">
              Chờ báo giá
            </span>
            <span v-else>{{ scope.row.amount | vnd }}</span>
          </template>
        </el-table-column>
        <el-table-column
...
.delivery-list-table .item-9271a {
