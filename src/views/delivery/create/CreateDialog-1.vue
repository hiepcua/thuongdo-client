<template>
  ...
  >
    <div class="create-delivery-dialog-882-wrap">
      ...
      >
        <span class="create-delivery-sub-title">Thời gian giao hàng</span>
        <div>
          <el-date-picker
      ...
      <div
        ...
        v-if="
          transporter_select.name == 'Viettel' ||
          transporter_select.name == 'Giao hàng tiết kiệm'
        "
      >
...
export default {
  ...
  methods: {
    ...
    checkDataPushError() {
      ...
      if (
        this.modelData.type == "" &&
        (this.transporter_select.name == "Viettel" ||
          this.transporter_select.name == "Giao hàng tiết kiệm")
      ) {
        flag = true;
