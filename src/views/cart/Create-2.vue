      ...
      >
        ...
        <div class="icon-item">
          <div class="price-item d-flex flex-column">
            ...
            <span class="price-red"
              >¥{{ element.unit_price_cny * element.quantity }}</span
            >
          </div>
        </div>
        <div class="icon-item last">
            ...
            <div class="cart-create-transport-option">
              ...
              <div class="wrap-2 d-flex flex-row pt-4">
                ...
                <div
                  ...
                  @click="item.is_inspections = !item.is_inspections"
                >
                  <img
                    src="@/static/icon/order-create/checked.svg"
                    alt=""
                    v-if="item.is_inspections"
                  />
                  <img
  ...
  methods: {
    ...
    caculaterCart() {
      ...
      this.listCart.forEach((item) => {
        ...
        item.total_all_money = total_item_money;

        total_amount_cny += total_item_money;
      });
