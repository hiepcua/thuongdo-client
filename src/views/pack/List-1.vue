  ...
  <div class="frame-content-common-2022 pack-list">
    ...
    <div class="table-element-custom-2022 pack-list-table" v-loading="loading">
      ...
      >
            ...
            <div class="d-flex flex-column">
              ...
              <div class="car-check-pack">
                ...
                >
                  ...
                  />
                  <img
                    src="@/static/icon/order-detail-v2/tab1/car-0.svg"
                    v-else
                  />
                </el-tooltip>
              </div>
        ...
        <el-table-column label="Phí khác" width="200">
          <template slot-scope="scope">
            <div class="d-flex flex-column">
    ...
    >
      <div class="title-wrap">
        <span class="line-1">Kiện hàng: D555</span>
        <span class="line-2">Mã đơn hàng: 199229</span>
        <img src="@/static/icon/pack/list/show-detail.svg" />
        <span class="show-detail-782fkme">Chi tiết</span>
        <img src="@/static/icon/pack/list/show-detail.svg" />
    ...
    viewCreateDialog() {
      ...
      if (bill_code_error) {
        let mes =
          "Kiện " +
          bill_code_error +
          " chưa về đến kho Việt Nam, không thể tạo giao hàng";
        this.$notify({
          title: "Có lỗi xảy ra",
          message: mes,
          type: "warning",
