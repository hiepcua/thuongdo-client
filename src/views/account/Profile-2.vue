    ...
    <div class="account-profile-info">
      <div class="account-profile-info-item-1">
        ...
        <div class="info-wrap-line">
          ...
          <div>
            <span class="label-2">{{ accountInfo.code }}</span>
          </div>
        </div>
        <div class="info-wrap-line">
          <span class="label-1">Họ và tên *</span>
          <div>
            <span class="label-2">{{ accountInfo.name }}</span>
          </div>
        </div>
        <div class="info-wrap-line">
          <span class="label-1">E-mail *</span>
          <div>
            <span class="label-2">{{ accountInfo.email }}</span>
          </div>
        </div>
        <div class="info-wrap-line">
          <span class="label-1">Số điện thoại *</span>
          <div>
            <span class="label-2">{{ accountInfo.phone_number }}</span>
          </div>
        </div>
        <div class="info-wrap-line">
          <span class="label-1">Kho nhận hàng</span>
          <div>
            <span class="label-2">Kho abc</span>
          </div>
        </div>
        <div class="info-wrap-line">
          <span class="label-1">Dịch vụ</span>
          <div>
            <span class="label-2">Kí gửi</span>
          </div>
        </div>
        <div class="info-wrap-line">
...
export default {
  ...
  mounted() {
    if (this.accountInfo.gender == null) {
      this.accountInfo.gender = "undetermined";
    }
    if (this.accountInfo.bod !== null) {
      let splitted = this.accountInfo.bod.split("-");
  ...
  methods: {
    ...
    deleteDelivery(item) {
      this.$confirm("Xác nhận xóa địa chỉ: " + item.name, "Warning", {
        confirmButtonText: "Đồng ý",
        cancelButtonText: "Hủy",
        type: "warning",
      })
