  ...
  <div class="frame-content-common-2022 order-list" id="ST2022">
    ...
    <div class="order-list-table" v-loading="loading">
      <div class="item-762a81" v-for="item in listOrder" :key="item.order_id">
        <div class="header">
          <span class="code" @click="viewDetail(item.order_id)"
            >Mã đơn hàng : {{ item.order_code }}</span
          >
          <span
            class="status"
        ...
        <div class="content-170692y d-flex">
                ...
                >
                  <div class="icon-item first">
                    ...
                    <div class="d-flex flex-column pl-3">
                      ...
                      <span class="sub-12x">{{ i.classification }}</span>
                    </div>
                  </div>
                  <div class="icon-item">
                  ...
                  <div class="icon-item">
                    <div class="price-item d-flex flex-column">
                      ...
                      <span class="price-red"
                        >¥{{ (i.unit_price_cny * i.quantity).toFixed(2) }}</span
                      >
                    </div>
                  </div>
                </div>
          ...
          <div class="info-170">
            ...
            <div class="item-826">
              ...
              <span>{{ item.inspection_cost | vnd }}</span>
            </div>
            <div class="item-826">
              <span>Phí ship TQ:</span>
              <span>{{ item.china_shipping_cost | vnd }}</span>
            </div>
            <div class="item-826">
