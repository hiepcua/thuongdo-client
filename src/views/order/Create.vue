  ...
  <div class="frame-content-common-2022 order-create">
          ...
          <div class="icon-item">
            ...
            <div class="attribute-input">
              <el-input
                ...
                v-model="pack.classification"
                class="frame-input-common-2022"
                size="mini"
                clearable
                :class="[pack.classification_err ? 'error-data-1988' : '']"
              ></el-input>
            </div>
          </div>
          <div class="icon-item icon-150">
    ...
    <div class="order-create-transport-option">
      <div class="wrap-1 d-flex flex-row">
        ...
        <div
          class="item-common item-checkbox"
          @click="is_shock_proof = !is_shock_proof"
        >
          <img
            src="@/static/icon/order-create/checked.svg"
            alt=""
  ...
  methods: {
    ...
    submitForm() {
      ...
      let data = {
        ...
        is_shock_proof: this.is_shock_proof,
    ...
    caculaterBag() {
      ...
      this.listOrder.forEach((item) => {
        ...
        if (item.classification) item.classification_err = false;
