<template>
  <div class="order-detail-v2-ncc">
              ...
              <div class="icon-item first info-main-892s">
                ...
                <div class="d-flex flex-column pl-3">
                  ...
                  <span class="line-4"
                    ...
                    <strong
                      >¥{{ (i.unit_price_cny * i.quantity).toFixed(2) }}</strong
                    ></span
                  >
                  <span class="line-5"
        ...
        <el-col :span="8">
          <div class="info-789ah-right d-flex flex-column">
            <div class="item-176">
              ...
              <span class="number-999">{{ hic.order_cost | vnd }}</span>
            </div>
            <div class="item-176">
            ...
            <div class="item-176">
              ...
              <span class="number-999">{{ hic.discount_cost | vnd }}</span>
            </div>
            <div class="item-176">
              <span>Phí kiểm đếm:</span>
              <span class="number-999">{{ hic.inspection_cost | vnd }}</span>
            </div>
            <div class="item-176">
              <span>Phí ship TQ:</span>
              <span class="number-999">{{
                hic.china_shipping_cost | vnd
              }}</span>
            </div>
            <div class="item-190-wrap">
              ...
              <span
                class="order-now-7788ab"
                @click="orderOne(hic)"
                v-if="
                  orderDetailV2.is_purchase &&
                  orderDetailV2.suppliers.length > 1
                "
              >
                Đặt hàng ngay</span
              >
    ...
    <BankConfirm
      v-if="orderDetailV2.is_purchase && orderDetailV2.suppliers.length > 1"
      :randomOpen="randomOpen"
      :supplierId="supplierSelect.id"
      :totalMoneyOrder="supplierSelect.total_amount"
...
.order-now-7788ab.disable {
  pointer-events: none;
}
.order-now-7788ab.disable img {
  margin-right: 5px;
}
