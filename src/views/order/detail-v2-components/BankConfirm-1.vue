      ...
      <el-col :span="16" v-if="accountInfo.offer">
        <div class="money-wrap">
          ...
          <div class="item">
            ...
            <span>{{
              accountInfo.e_wallet < totalMoneyOrder
                ? "0"
                : (accountInfo.e_wallet - totalMoneyOrder) | vnd
            }}</span>
          </div>
...
export default {
  ...
  methods: {
    ...
    sentPaymentOrder() {
      if (this.modelData.confirmation == 0) {
        this.$notify({
          title: "Vui lòng kiểm tra lại thông tin",
          message: "Vui lòng chọn xác nhận thanh toán",
          type: "warning",
        });
        return;
      }
  ...
  watch: {
    ...
    bankId() {
      this.linkImgBank =
        ...
        this.bankId +
        "-19033416322666-qr_only.png?addInfo=NAP " +
